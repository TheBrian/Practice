...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        for x in range(self.width):
            ...
            for y in range(self.height):
                ylist.append(dirt_amount)
            self.dirt.append(ylist)
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
    #   gets robot current positions
        xval = math.floor(pos.get_x())
        yval = math.floor(pos.get_y())
    # sets the new dirty value as current value of tile - capacity till it hits 0.
        self.dirt[xval][yval] -= capacity
        if self.dirt[xval][yval] < 0:
            self.dirt[xval][yval] = 0
    ...
    def is_tile_cleaned(self, m, n):
        ...
        Note: The tile is considered clean only when the amount of dirt on this
              tile is 0.
        """
    #   tiles with 0 as dirt value are cleaned
        return self.dirt[m][n] == 0

    def get_num_cleaned_tiles(self):
        """
        Returns: an integer; the total number of clean tiles in the room
        """
    #   takes the tiles with dirt values of 0 and adds them to a count.
        count = 0
        for x in range(self.width):
            for y in range(self.height):
                if self.dirt[x][y] == 0:
    ...
    def is_position_in_room(self, pos):
        ...
        """
    #   getting current position of robot
        xval = math.floor(pos.get_x())
        yval = math.floor(pos.get_y())
    #   Checks if width and height are above 0 and below the set ints for their dimensions
        if xval < 0 or xval >= self.width:
            return False
        if yval < 0 or yval >= self.height:
            return False
        else: return True
...
class Robot(object):
    ...
    def set_robot_position(self, position):
        ...
        """
    #   set robot position with random position
    ...
    def set_robot_direction(self, direction):
        ...
        """
    #   set robot direction with random direction
...
class EmptyRoom(RectangularRoom):
    ...
    def get_num_tiles(self):
        ...
        Returns: an integer; the total number of tiles in the room
        """
    #   taking width * height of room to return area (num of tiles)
    ...
    def is_position_valid(self, pos):
        ...
        Returns: True if pos is in the room, False otherwise
        """
    #   Checking if the a given position is within the dimensions of the room to provide a boolean response
    ...
    def get_random_position(self):
        ...
        """
    #   using random function to provide random x and y within the height and width of the room
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_tile_furnished(self, m, n):
        ...
        """
    #   Checks if the a tile at a given coordinates is occupied by furniture
        tile = (m, n)
    ...
    def is_position_furnished(self, pos):
        ...
        """
    #   Checks if current position is furnished or not.
        xval = math.floor(pos.get_x())
        yval = math.floor(pos.get_y())
        if FurnishedRoom.is_tile_furnished(self, xval, yval) is True:
            return True
        else:
            return False
    ...
    def is_position_valid(self, pos):
        ...
        """
    #   Same position valid method from previous subclass
        if pos.get_x() >= 0 and pos.get_x() < self.width and pos.get_y() >= 0 and pos.get_y() < self.height and FurnishedRoom.is_position_furnished(self, pos) == False:
            return True
        else:
            return False
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        """
    #   Check current position for later evaluation
        new_pos = self.position.get_new_position(self.direction, self.speed)
    #   if the current position it's moving to is within the room, move to it and clean
        if self.room.is_position_in_room(new_pos):
            self.position = new_pos
    #   if current position isn't moving int oa valid position, change direction.
        else:
            self.direction = random.randrange(360)
    #   Robot cleans current position
